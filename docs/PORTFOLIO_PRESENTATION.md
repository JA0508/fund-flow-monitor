...
- v3.16 extends provider-contract identity into analytical continuity: canonical observations, regime episodes, relationship alignment and robustness universes keep provider-contract continuity segments separate.
- v3.17 separates historical availability from contract-qualified analytical readiness: legacy REAL cache can be replayed and audited, but qualified continuity-sensitive analytics require explicit verified primary-provider lineage.

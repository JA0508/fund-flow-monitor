...
7. 如需更细证据，可运行 `tools/inspect_theme_dynamics.py` 查看主题状态路径和结构分歧，或运行 `tools/inspect_observation_grain.py` 查看 raw event grain、bucket collision 和 canonical observation lineage。

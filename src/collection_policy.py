...
def decide_collection_eligibility(
    ...
    base = {
        ...
        "cross_exchange_alignment_state": None,
    ...
    base.update(
        {
            ...
            "market_scope": date_decision.get("market_scope"),
            "source_strategy": date_decision.get("source_strategy"),
            "source_classification": date_decision.get("source_classification"),
            "cross_exchange_alignment_state": date_decision.get("cross_exchange_alignment_state"),
